...
def add_ospf_neighbor(module, current_switch, dict_area_id):
    """
...
def assign_leafcluster_ospf_interface(module, dict_area_id, current_switch):
    """
...
def main():
    ...
    if routing_protocol == 'ospf':
        ...
        message += add_ospf_neighbor(module, current_switch, dict_area_id)
        message += add_ospf_redistribute(module, current_switch)
        message += make_interface_passive(module, current_switch)
    if current_switch in spine_list and spine_list.index(current_switch) == 0:
        message += assign_leafcluster_ospf_interface(module, dict_area_id, current_switch)
